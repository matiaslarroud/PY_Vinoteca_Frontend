...
const createCliente = ({ exito, filtro, onChangeFiltro }) => {
    ...
    useEffect(()=>{
     ...
     const handleBuscar = async (e) => {
        e.preventDefault();
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/gestion/cliente/buscar`, {
        method: "POST",
    ...
    return(
        <>
            <div className="form-container">
                <h1 className="titulo-pagina">Busqueda avanzada de cliente</h1>
                <br/>  
                        ...
                        <div className="form-col">
                            ...
                            <div className="checkbox-modern">
                                <input
                                    ...
                                    checked={filtros.cuentaCorriente}
                                    onChange={(e) =>
                                    setFiltros({
                                        ...filtros,
