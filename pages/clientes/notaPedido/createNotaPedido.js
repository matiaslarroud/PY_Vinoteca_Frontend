...
const initialStateNotaPedido = {
        ...
        envio:false , envioDireccion:'' , presupuesto:'', medioPago:''
    }
...
const createNotaPedido = ({exito}) => {
    ...
    const clickChange = async(e) => {
        ...
        if (notaPedido.envio === true) {
            bodyData.envioDireccion = notaPedido.envioDireccion;
        }
...
export default createNotaPedido;