...
const updateReciboPago = ({exito , reciboPagoID}) => {
    ...
    const fetchData = (param) => {
        fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/cliente/reciboPago/${param}`)
            .then((a)=>{return a.json()})
                .then((s)=>{
                    setRecibo(s.data)
                })
    ...
    const clickChange = async(e) => {
        ...
        const resRecibo = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/cliente/reciboPago/${reciboPagoID}`, {
            method: 'PUT',
...
export default updateReciboPago;