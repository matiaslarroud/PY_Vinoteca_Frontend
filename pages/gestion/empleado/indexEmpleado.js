...
import FormularioEmpleadoUpdate from './updateEmpleado'
import FormularioEmpleadoCreate from './createEmpleado'
...
const deleteEmpleado = async(empleadoID) => {
    ...
    await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/gestion/empleado/${empleadoID}`,
        {
            method:'DELETE',
            headers: {
  ...
  {mostrarModalCreate && (
    <div className="modal">
      <div className="modal-content">
        ...
        <FormularioEmpleadoCreate exito={() => 
          {
              setMostrarModalCreate(false)
              fetchData()
          }} />
  ...
  {mostrarModalUpdate && (
    <div className="modal">
      <div className="modal-content">
        ...
        <FormularioEmpleadoUpdate 
            empleadoID={mostrarModalUpdate} 
            exito={() => 
                {
  ...
  <div className="botonera">
    ...
    <button className="btn-icon" onClick={() => setMostrarModalCreate(true)} title="Agregar Empleado">
         <FaPlus />
    </button>               
  </div>
                  ...
                  <tr key={_id}>
                      ...
                      <td className="columna">
                        <div className="acciones">
                          ...
                          <button onClick={() => deleteEmpleado(_id)}  className="btn-icon" title="Eliminar">
                              <FaTrash />
                          </button>
                        </div>
                      </td>
