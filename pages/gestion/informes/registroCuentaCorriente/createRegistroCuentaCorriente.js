...
const indexCreateRegistoCuentaCorriente = ({exito , param , tipo}) => {
  ...
  const fetchData = async (param) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/gestion/caja/cuentacorriente/cliente/${param}`);
            ...
            {resumenCaja && (
              <div className="resumen-caja">
                <div className="card-resumen ingreso">
                  ...
                  <span className="valor">${resumenCaja.pagosEntrada}</span>
                </div>

                <div className="card-resumen egreso">
                  <span className="titulo">Egresos</span>
                  <span className="valor">${resumenCaja.pagosSalida}</span>
                </div>
                ...
                <div className="card-resumen cc">
                  ...
                  <span className="valor">${resumenCaja.totalCuentaCorriente}</span>
                  <span className="saldoRestante">${resumenCaja.saldoRestante}</span>
                </div>
              </div>
            )}
          </div>
