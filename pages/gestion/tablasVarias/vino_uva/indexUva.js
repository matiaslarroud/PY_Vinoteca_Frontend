...
import FormularioUvaUpdate from './updateUva'
import FormularioUvaCreate from './createUva'
    ...
    return(
        <>
            ...
            <div className="botonera">
                    ...
                    <button className="btn-icon" onClick={() => setMostrarModalCreate(true)} title="Agregar Uva">
                         <FaPlus />
                    </button>               
            </div>
                                    ...
                                    <tr key={_id}>
                                        ...
                                        <td className="columna">
                                            <div className="acciones">
                                                ...
                                                <button onClick={() => deleteUva(_id)} className="btn-icon">
                                                    <FaTrash />
                                                </button>
                                            </div>
                                        </td>
